...
public class RegisterTaxiActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.register_taxi); //Layout da Activity
	...
	public void register(final String[] data) {
		...
		progressDialog = ProgressDialog.show(RegisterTaxiActivity.this, 
					...
					HttpPost httppost = new HttpPost(getString(R.string.url_webservice) + getString(R.string.url_create_user)
						...
						if(result.equals("1")){
							...
							mHandler.post(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(RegisterTaxiActivity.this, getString(R.string.register_error_duplicate), Toast.LENGTH_SHORT).show();
							...
							mHandler.post(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(RegisterTaxiActivity.this, getString(R.string.register_error_param), Toast.LENGTH_SHORT).show();
	...
	private void gotoHome() {
		Intent i = new Intent(RegisterTaxiActivity.this, MainActivity.class);
		startActivity(i);
	}
	
	private void gotoContinueInfo(String email, String password) {
		Intent i = new Intent(RegisterTaxiActivity.this, RegisterContinueActivity.class);
	...
	protected void onStop() {
		super.onStop();
		RegisterTaxiActivity.this.finish();
	}
}